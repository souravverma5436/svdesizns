              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                {selectedProject.websiteUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 mb-4 mr-3 px-4 py-2 bg-gradient-to-r from-primary to-secondary rounded-full text-sm font-medium hover:shadow-lg hover:shadow-primary/25 transition-all cursor-hover"
                  >
                    🌐 Visit Website
                  </a>
                )}
                {selectedProject.instagramUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full text-sm font-medium transition-all cursor-hover hover:shadow-lg"
                    style={{ background: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', boxShadow: '0 0 0 0 rgba(220,39,67,0)' }}
                    onMouseEnter={e => e.currentTarget.style.boxShadow = '0 4px 20px rgba(220,39,67,0.4)'}
